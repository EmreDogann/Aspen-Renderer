...
namespace Aspen {
    ...
    AspenSwapChain::AspenSwapChain(AspenDevice &deviceRef, VkExtent2D extent)
        : device{deviceRef}, windowExtent{extent} {
        init();
    }

    AspenSwapChain::AspenSwapChain(AspenDevice &deviceRef, VkExtent2D extent, std::shared_ptr<AspenSwapChain> previous)
    ...
    VkResult AspenSwapChain::submitCommandBuffers(
    ...
    VkSurfaceFormatKHR AspenSwapChain::chooseSwapSurfaceFormat(
    ...
    VkPresentModeKHR AspenSwapChain::chooseSwapPresentMode(
