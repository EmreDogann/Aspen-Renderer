...
namespace Aspen {
    ...
    AspenDevice::AspenDevice(AspenWindow &window) : window{window} {
        ...
        // Describes what features of the physical device we want to use.
        createLogicalDevice();
    ...
    void AspenDevice::createSurface() { window.createWindowSurface(instance, &surface_); }
    ...
    void AspenDevice::populateDebugMessengerCreateInfo(
    ...
    std::vector<const char *> AspenDevice::getRequiredExtensions() {
    ...
    VkFormat AspenDevice::findSupportedFormat(
    ...
    void AspenDevice::copyBufferToImage(
    ...
    void AspenDevice::createImageWithInfo(
